<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WNHI.aspx.cs" Inherits="WNHS" %>
...
<body runat="server" id="masterPageBody">
    ...
    <header>
        ...
        <div class="name">
            <asp:Label ID="lblWNEI" runat="server" Text="Wydział Nauk Humanistycznych i Informatyki"></asp:Label>
        </div>
        <div class="content">
            <asp:GridView ID="gvKsiazkaTelefoniczna" runat="server" AutoGenerateColumns="True" CssClass="gridView" AllowPaging="True" OnPageIndexChanging="gvKsiazkaTelefoniczna_PageIndexChanging" showfooter="true" >
